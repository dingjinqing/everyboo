                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 text-center">
                                    <div id="qrcode" style="width: 100%;display:flex; flex-direction: column;align-items: center;margin-bottom: 20px;"></div>
                                    <p>长按此邀请二维码，保存图片，再发送给你的好友吧</p>
                                </div>
                            </div>
                        </div>
                    </div>
