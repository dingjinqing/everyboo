    ...
    <div class="content-wrap">
        <div class="content">
            ...
            <div class="blog-fullwidth-area ptb-100">
                <div class="container">
                    <div class="row">
                        <div v-if="articles.length === 0" class="col-md-12 text-center" style="margin-bottom: 20px;">暂无爱心公益资讯</div>
                        <div v-for="item in articles" class="col-md-4 col-sm-6">
                            <div class="blog-details mb-30">
                                ...
                                <div class="blog-meta">
                                    <h4><a :href="'<%=path%>/heart-detail?id=' + item.id" v-text="item.title"></a></h4>
                                    <ul class="meta">
                                    ...
                                    <a :href="'<%=path%>/heart-detail?id=' + item.id">查看</a>
                                </div>
                            </div>
                        </div>
                    </div>
