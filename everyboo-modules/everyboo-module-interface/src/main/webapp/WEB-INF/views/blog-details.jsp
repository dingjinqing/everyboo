											...
											<div class="post-info">
												<ul>
													<li><i class="fa fa-user"></i> <span
														v-text="article.publisher"></span></li>
													<li><i class="fa fa-calendar"></i> <span
														v-text="article.createDate"></span></li>
												</ul>
											</div>
											<!--
								...
								<div class="blog-sidebar mrg-for-sm-top">
									<div class="single-sidebar">
										...
										<div class="recent-all">
											...
											<div v-else v-for="item in latestArticles"
												class="recent-img-text mb-20">
												<div class="recent-img">
													<a :href="'<%=path%>/blog-detail?id=' + item.id"><img
														:src="item.coverImageUrl" alt="" class="img-responsive"></a>
												</div>
												<div class="recent-text">
													...
													<div class="post-info">
														<ul>
															<li><i class="fa fa-calendar"></i> <span
																v-text="item.createDate"></span></li>
														</ul>
													</div>
												</div>
											</div>
									...
									.post(
											...
											function(data) {
												if (data.success === true) {
													...
													view.article.coverImageUrl = BASE_URL
															+ MODULE_ADMIN
															+ view.article.coverImageUrl
