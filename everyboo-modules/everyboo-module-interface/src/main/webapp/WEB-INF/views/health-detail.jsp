                                    ...
                                    <div class="recent-all">
                                        ...
                                        <div v-else v-for="item in latestArticles" class="recent-img-text mb-20">
                                            <div class="recent-img">
                                                <a :href="'health-detail.jsp?id=' + item.id"><img :src="item.coverImageUrl" alt="" class="img-responsive"></a>
                                            </div>
                                            <div class="recent-text">
                                                <h4>
                                                    <a :href="'health-detail.jsp?id=' + item.id" v-text="item.title"></a>
                                                </h4>
                                                <div class="post-info">
                                                    <ul>
                                                        <li>
