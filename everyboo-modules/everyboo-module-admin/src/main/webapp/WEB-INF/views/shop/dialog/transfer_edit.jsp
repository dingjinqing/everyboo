                                     	...
                                     	<c:choose>
                                     		<c:when test="${not empty bean }">
                                     			<select name="jtype" data-rule="交易类型:required;" >
                                     				<option value=16 <c:if test="${16 eq bean.jtype }">selected</c:if> >转账收入</option>
                                     				<option value=17 <c:if test="${17 eq bean.jtype }">selected</c:if> >转账支出</option>
                                     			</select>
                                     		</c:when>
                                     		<c:otherwise>
                                     			<select name="jtype" data-rule="交易类型:required;" >
													<option value=16 >转账收入</option>
													<option value=17 >转账支出</option>
                                     			</select>
                                     		</c:otherwise>
                                     	</c:choose>
                                     </label>
