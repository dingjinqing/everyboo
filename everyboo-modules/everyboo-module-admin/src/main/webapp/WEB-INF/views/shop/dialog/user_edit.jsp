...
<body>
	...
	<div id="addForm" class="mgt20">
		...
		<input type="hidden" name="jiaoyimima" value="${bean.jiaoyimima }"/>
		<input type="hidden" name="shopUserExts.id" value="${bean.shopUserExts.id }"/>
		<input type="hidden" name="shopUserExts.createDate" value="${bean.shopUserExts.createDate}"/>
		<div class="">
			<div class="J_formTable l_form_table">
				<table class="not_hightlight">
					<tr>
                     ...
                     <tr>
						<td class="l_title w150"><b class="cRed">*</b>账户积分</td>
                         <td>
                             <div class="J_toolsBar fl">
                                 <div class="t_text w200 ml10">
                                     <label>
                                     	<c:choose>
                                     		<c:when test="${not empty bean }">
                                     			<input type="text" name="shopUserExts.credits" data-rule="账户积分:required;" value="${bean.shopUserExts.credits }" />
                                     		</c:when>
                                     		<c:otherwise>
                                     			<input type="text" name="shopUserExts.credits" data-rule="账户积分:required;" value="" />
                                     		</c:otherwise>
                                     	</c:choose>
                                     </label>
                                 </div>
                             ...
                             <div class="J_toolsBar fl">
                                 <div class="t_text w200 ml10">
                                     <label>
                                     	<c:choose>
                                     		<c:when test="${not empty bean }">
                                     			<input type="text" name="shopUserExts.balance"  value="${bean.shopUserExts.balance }" />
                                     		</c:when>
                                     		<c:otherwise>
